...
const char* patternInstructionInfoString[] = { "(1) Portamento up. Value: $%04X",
...
const char* filterTypeString[] = { "No Filter Type", "Low Pass", "Band Pass", "High Pass" };

const char* filterChannelsEnabledString[] = { "Active chn: None (0)", "Active chn: 1 (1)",  "Active chn: 2 (2)",
                                              "Active chn: 1+2 (3)",  "Active chn: 3 (4)",  "Active chn: 1+3 (5)",
                                              "Active chn: 2+3 (6)",  "Active chn: All (7)" };
