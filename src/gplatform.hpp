// GTUltra platform layer (replaces bme for the editor).
#ifndef GPLATFORM_HPP
#define GPLATFORM_HPP

#include <SDL.h>

// ---------------------------------------------------------------------------
// Config / error codes (legacy BME_* names kept for call-site stability)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Flags / constants used by the editor
// ---------------------------------------------------------------------------
